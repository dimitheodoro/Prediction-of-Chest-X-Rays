...
def get_activation_map(image_path,my_model,labels):
        ...
        return image_loaded,heatmap,predictions1,class_predicted_name,class_predicted_name
...
if uploaded_file is not None:
  image_loaded,heatmap,predictions1,class_predicted_name,class_predicted_name = get_activation_map(uploaded_file,model,labels)
